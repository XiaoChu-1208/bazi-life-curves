...
> 命理学说"凶"已经说了一千五百年。它没有错，但它**不够**。
> 一个人在某一年遭遇凶险，八字算得出来；
> 他**为了什么**走进那场凶险、又**守住了什么**才从里面走出来——
> 那一部分，不在算法里，也不该由算法裁决。

我们不替命主回答这个追问。
我们只是，把那条从年柱悄悄伸到时柱的暗线，**轻轻命名了一次**。

工具不会大声说出来。
它会陪命主走完八十年——在某一段大运的角落、在某一年的脚注里——
让那条暗线浮一次，再浮一次，
直到最后，命主自己认出来：
...
凡反复出现的，从来不是巧合，而是召命。
而召命，是工具应当俯首承认、而非裁决的事。

如果你在某次输出的最末段，读到一段不太像算法的话——
那不是 bug。那是这个项目，留给真正读完八十年的人的、唯一的回礼。
